...
export const PERIODIC_SERVICE_OPTIONS: ManualServiceOption[] = [
  { label: "Wet PM / Oil Service", value: "Wet PM / Oil Service", kind: "periodic", category: "preventive_maintenance", planned: true, recurring: true },
  { label: "PM-A", value: "PM-A", kind: "periodic", category: "preventive_maintenance", planned: true, recurring: true },
  { label: "PM-B", value: "PM-B", kind: "periodic", category: "preventive_maintenance", planned: true, recurring: true },
  { label: "Heavy Inspection", value: "Heavy Inspection", kind: "periodic", category: "dot_inspection", planned: true, recurring: true },
  ...
  { label: "Cabin Air Filter", value: "Cabin Air Filter", kind: "periodic", category: "hvac_ac", planned: true, recurring: true, aliases: ["Cabin Air Filter Inspection/Replacement", "Cabin Air Filter Replacement"] },
  { label: "Fuel Filters", value: "Fuel Filters", kind: "periodic", category: "fuel_system", planned: true, recurring: true },
  ...
  { label: "Air Dryer", value: "Air Dryer", kind: "periodic", category: "air_system", planned: true, recurring: true },
  { label: "DOT Annual", value: "DOT Annual", kind: "periodic", category: "dot_inspection", planned: true, recurring: true, aliases: ["Annual Inspection", "DOT Inspection", "Annual DOT"] },
  { label: "Coolant Chemistry Test", value: "Coolant Chemistry Test", kind: "periodic", category: "cooling_system", planned: true, recurring: true },
  { label: "Transmission Service", value: "Transmission Service", kind: "periodic", category: "transmission_clutch", planned: true, recurring: true },
  { label: "Drive Axle Oil", value: "Drive Axle Oil", kind: "periodic", category: "driveline_differential", planned: true, recurring: true, aliases: ["Synthetic Drive Axle Oil", "Drive Axle Oil Change"] },
...
export const REPAIR_SERVICE_OPTIONS: ManualServiceOption[] = [
  ...
  { label: "Turbo Repair", value: "Turbo Repair", kind: "repair", category: "turbo_air_intake", planned: false, recurring: false },
  ...
  { label: "Coolant Leak Repair", value: "Coolant Leak Repair", kind: "repair", category: "cooling_system", planned: false, recurring: false },
  ...
  { label: "APU / TriPac Repair", value: "APU / TriPac Repair", kind: "repair", category: "apu", planned: false, recurring: false },
  { label: "Towing", value: "Towing", kind: "repair", category: "other", planned: false, recurring: false },
  { label: "Diagnostic", value: "Diagnostic", kind: "repair", category: "other", planned: false, recurring: false },
  { label: "Road Service", value: "Road Service", kind: "repair", category: "other", planned: false, recurring: false },
...
export function manualMaintenanceCategory(kind: ManualMaintenanceKind, serviceType: string): string {
  return manualServiceOption(kind, serviceType)?.category ?? (kind === "periodic" ? "preventive_maintenance" : "other");
}
