...
-- =============================================================================
-- 2026-07-23 - Tracking saved support locations
-- Mirrors: 20260723010000_tracking_fleet_locations.sql
-- =============================================================================
...
-- =============================================================================
-- 2026-08-02 — New-vehicle maintenance onboarding
-- Mirrors: 20260802133726_vehicle_maintenance_onboarding.sql
-- =============================================================================
...
alter table public.vehicles add column if not exists creation_request_key uuid;
...
begin
  ...
  where p.organization_id = v_org and p.vehicle_id = p_vehicle_id;
  ...
  insert into public.maintenance_rule_vehicle_states (
    ...
    tracking_baseline_mileage, tracking_baseline_date, tracking_baseline_engine_hours
  )
  select
    v_org,
    r.id,
  ...
  set tracking_baseline_mileage = case
      ...
      updated_at = now()
  where r.organization_id = v_org and r.vehicle_id = p_vehicle_id and r.active = true;
