...
export default async function AmazonCandidateDetailPage({
  params,
}: {
  ...
  const view = await getAmazonCandidateEditorForUi({ actor, batchId: id, candidateId });
  if (!view) notFound();
  return (
    <div className="space-y-4">
      ...
      <h1 className="text-xl font-bold">Amazon statement candidate</h1>
